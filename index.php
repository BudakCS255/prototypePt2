...
$can_upload = isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'upload';
$can_view_download = isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'view/download';
